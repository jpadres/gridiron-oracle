...
identificadores huérfanos de `tools/no-undef.mjs`, la simulación de draft y que
ninguna pantalla le preste al dato la hora del build (`tests/dataDate.test.mjs`). **Los
