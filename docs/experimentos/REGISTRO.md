...
| E27 | Hay algún SUBCONJUNTO donde el modelo bate al spread | 3.737 apuestas, 8 subconjuntos preregistrados | 52,381% de equilibrio | acierto, IC95% con Bonferroni (z=2,734), partición 2012-2019 / 2020-2025 | IC inferior > 52,4% en confirmación, n>=200 en las dos etapas | **cero de ocho** llegaron a confirmación; lo mejor fue 52,26% en descubrimiento y 49,84% después | **FALLA** (`docs/PREREGISTRO_edge_subconjuntos.md`) |
