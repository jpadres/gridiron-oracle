...
| `pred_margin_free` (MAE 10.29, Brier 0.2186) | **Medido** desde 2026-09-05: el backtest lo saca al payload (`validation.overall.free_brier`) y la página de survivor lo lee de ahí. Las del proyecto original eran 10.24 / 0.2187 |
